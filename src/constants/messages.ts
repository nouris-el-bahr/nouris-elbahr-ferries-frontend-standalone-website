...
export const MESSAGES = {
  ...
  REPORTS: {
    ...
    CONSOLIDATED: {
      ...
      DESCRIPTION: "Générez la facture consolidée paiement + ventes",
      SELECT_SNAPSHOT: "Snapshot de référence",
      SELECT_INVOICE_FILE: "Fichier de facture",
      SELECT_SALES_FILE: "Facture de ventes (optionnel)",
      BILLING_PERIOD: "Période de facturation",
      DOWNLOAD_DATE: "Date de téléchargement",
      PERIOD_START: "Début",
      PERIOD_END: "Fin",
      GENERATE_BUTTON: "Générer la facture consolidée",
      GENERATING: "Génération en cours...",
      SUCCESS: "Facture consolidée générée",
